...
const CaseStudy = () => {
  ...
  return (
    <main className="bg-[var(--surface)] min-h-screen selection:bg-[var(--primary)] selection:text-white pb-32">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-end pt-40 overflow-hidden">
        <div className="container-editorial relative z-10 px-4 md:px-0 mb-20">
          ...
          <div className="mt-12 md:mt-24">
             <button 
               onClick={() => (window as any).lenis?.scrollTo('#overview')}
               className="group flex flex-col items-center md:items-start gap-4 opacity-30 hover:opacity-100 transition-opacity"
             >
                ...
                <i className="ri-arrow-down-line text-2xl text-white group-hover:translate-y-2 transition-transform duration-500"></i>
             </button>
           </div>
        </div>
      ...
      {/* Overview & Metadata */}
      <section id="overview" className="py-32 md:py-48 border-t border-[var(--on-surface)]/5">
